...
import carevon from '../image/blogs/carevon.png';
import webApp from '../image/blogs/web app.png';
import mariwa from '../image/blogs/mariwa.png';
import blog13 from '../image/blogs/blog-12.jpeg';
...
const CATEGORIES = [
  {
    img: carevon,
    icon: <AiFillAndroid />,
    title: "Caveron Enterprises Limited",
    desc: "https://caveron.co.ke/",
  },
  {
    img: webApp,
    icon: <AiFillAndroid />,
    title: "Culinary Companion",
    desc: "https://culinarycompanion.netlify.app/",
  },
  {
    img: mariwa,
    icon: <AiFillAndroid />,
